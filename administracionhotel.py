...
def consultar_habitaciones_por_numero():
    ...
    conexion.close()
# CONSULTA POR TIPO DE HABITACIÓN
def consultar_habitaciones_por_tipo():
    ...
    for habitacion in habitaciones:
        print(f"Num. Habitación: {habitacion[0]}, Tipo: {habitacion[1]}, Disponible: {habitacion[2]}")
    conexion.close()
# cONSULTA POR ESTADO DE HABITACIÓN
...
def agregar_reserva():
    ...
    # Convertir las fechas de nacimiento, check-in y check-out
...
def modificar_reserva():
    ...
    # Consulta para obtener la reserva activa
    ...
    if reserva:
        ...
        # Imprimir los datos de la reserva con los nombres de las columnas
        print("\n--- Datos de la Reserva Encontrada ---")
        for column_name, value in zip(column_names, reserva):
            print(f"{column_name}: {value}")

        # Modificar la fecha de check-in
        while True:
        ...
        # Modificar la fecha de check-out
        while True:
        ...
        # Confirmación antes de realizar la modificación
        ...
        # Actualización de la reserva en la base de datos
...
def eliminar_reserva():
    ...
    # Consultar la reserva antes de cancelarla
    cursor.execute("SELECT * FROM reservas WHERE id_reserva = %s AND estado = 'ACTIVA'", (id_reserva,))
    reserva = cursor.fetchone()

    if reserva:
        # Mostrar los datos de la reserva antes de cancelarla
        ...
        # Preguntar al usuario si está seguro de cancelar la reserva
        ...
        if confirmacion == "S":
            ...
            # Cambiar el estado de la habitación a 'SI' (disponible)
            numero_habitacion = reserva[8]  # Suponiendo que el número de habitación está en la columna 8
